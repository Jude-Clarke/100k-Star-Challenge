...
var datastarHeatVisionTexture = THREE.ImageUtils.loadTexture( "index_files/sharppoint.png" );

//	bright flashy named stars graphic
var starPreviewTexture = THREE.ImageUtils.loadTexture( 'index_files/star_preview.png', undefined, setLoadMessage("Focusing optics")	);
var starColorGraph = THREE.ImageUtils.loadTexture( 'index_files/star_color_modified.png' );
...
function generateHipparcosStars(){
	...
	var starBaseTexture = THREE.ImageUtils.loadTexture( 'index_files/starbase.png');
